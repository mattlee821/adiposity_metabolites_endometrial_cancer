...
a <- read_exposure_data("adiposity_metabolites_endometrial_cancer/data/adiposity/bmi_snps_combined.txt",
                                  clump = F,
                                  sep = "\t",
                                  snp_col = "SNP",
...
a1 <- read_exposure_data("adiposity_metabolites_endometrial_cancer/data/adiposity/whr_snps_combined.txt",
                                  clump = F,
                                  sep = "\t",
                                  snp_col = "SNP",
                                  beta_col = "beta.exposure",
...
a2 <- read_exposure_data("adiposity_metabolites_endometrial_cancer/data/adiposity/whradjbmi_snps_combined.txt",
                                  clump = F,
                                  sep = "\t",
                                  snp_col = "SNP",
                                  beta_col = "beta.exposure",
