...
my_files <- list.files(path = "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/adiposity_instruments/whr/", pattern = "*txt")
adiposity <- list()
for (i in seq_along(my_files)) {
  adiposity[[i]] <- read.table(paste0("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/adiposity_instruments/whr/",file = my_files[i]), header = T, sep = " ")
}
...
my_files <- list.files(path = "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/metabolite_instruments/whr/", pattern = "*txt")
metabolites <- list()
for (i in seq_along(my_files)) {
  metabolites[[i]] <- read.table(paste0("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/metabolite_instruments/whr/",file = my_files[i]), header = T, sep = "\t")
}
...
for (i in 1:length(meta_table))
  write.table(meta_table[[i]], paste0("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/adiposity/whr/",my_files[[i]]), 
