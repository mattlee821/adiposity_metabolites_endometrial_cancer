...
# header
HEADER=/newhome/ml16847/001_projects/adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/metabolite_instruments/header
...
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite1})\n/" ${DATA_DIR}/${metabolite1}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite2})\n/" ${DATA_DIR}/${metabolite2}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite3})\n/" ${DATA_DIR}/${metabolite3}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite4})\n/" ${DATA_DIR}/${metabolite4}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite5})\n/" ${DATA_DIR}/${metabolite5}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite6})\n/" ${DATA_DIR}/${metabolite6}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite7})\n/" ${DATA_DIR}/${metabolite7}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite8})\n/" ${DATA_DIR}/${metabolite8}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite9})\n/" ${DATA_DIR}/${metabolite9}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite10})\n/" ${DATA_DIR}/${metabolite10}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite11})\n/" ${DATA_DIR}/${metabolite11}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite12})\n/" ${DATA_DIR}/${metabolite12}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite13})\n/" ${DATA_DIR}/${metabolite13}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite14})\n/" ${DATA_DIR}/${metabolite14}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite15})\n/" ${DATA_DIR}/${metabolite15}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite16})\n/" ${DATA_DIR}/${metabolite16}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite17})\n/" ${DATA_DIR}/${metabolite17}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite18})\n/" ${DATA_DIR}/${metabolite18}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite19})\n/" ${DATA_DIR}/${metabolite19}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite20})\n/" ${DATA_DIR}/${metabolite20}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite21})\n/" ${DATA_DIR}/${metabolite21}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite22})\n/" ${DATA_DIR}/${metabolite22}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite23})\n/" ${DATA_DIR}/${metabolite23}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite24})\n/" ${DATA_DIR}/${metabolite24}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite25})\n/" ${DATA_DIR}/${metabolite25}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite26})\n/" ${DATA_DIR}/${metabolite26}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite27})\n/" ${DATA_DIR}/${metabolite27}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite28})\n/" ${DATA_DIR}/${metabolite28}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite29})\n/" ${DATA_DIR}/${metabolite29}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite30})\n/" ${DATA_DIR}/${metabolite30}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite31})\n/" ${DATA_DIR}/${metabolite31}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite32})\n/" ${DATA_DIR}/${metabolite32}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite33})\n/" ${DATA_DIR}/${metabolite33}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite34})\n/" ${DATA_DIR}/${metabolite34}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite35})\n/" ${DATA_DIR}/${metabolite35}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite36})\n/" ${DATA_DIR}/${metabolite36}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite37})\n/" ${DATA_DIR}/${metabolite37}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite38})\n/" ${DATA_DIR}/${metabolite38}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite39})\n/" ${DATA_DIR}/${metabolite39}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite40})\n/" ${DATA_DIR}/${metabolite40}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite41})\n/" ${DATA_DIR}/${metabolite41}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite42})\n/" ${DATA_DIR}/${metabolite42}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite43})\n/" ${DATA_DIR}/${metabolite43}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite44})\n/" ${DATA_DIR}/${metabolite44}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite45})\n/" ${DATA_DIR}/${metabolite45}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite46})\n/" ${DATA_DIR}/${metabolite46}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite47})\n/" ${DATA_DIR}/${metabolite47}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite48})\n/" ${DATA_DIR}/${metabolite48}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite49})\n/" ${DATA_DIR}/${metabolite49}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite50})\n/" ${DATA_DIR}/${metabolite50}
sed -i "1s/^/$(head -n1 ${DATA_DIR}/${metabolite51})\n/" ${DATA_DIR}/${metabolite51}
