...
data <- read.table("adiposity_metabolites_endometrial_cancer/analysis/003_metabolite_endometrial/female/mr_results_formatted.txt", header = T, sep = "\t")
...
## mvmr ====
data <- read.table("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/combined/combined_results.txt", header = T, sep = "\t")
...
## negative ontrol
negative_control <- read.table("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/combined/negative_control_mvmr_results_formatted.txt", header = T, sep = "\t")
...
## save ====
write.table(data, "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/combined/2smr_mvmr_formatted_results.txt", 
