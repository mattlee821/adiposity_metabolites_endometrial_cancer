...
# MVMR main plot ====
increasing_increasing <- read.table("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/associated_metabolites_increasing_increasing.txt", header = T, sep = "\t")
increasing_increasing <- increasing_increasing[,1]
decreasing_decreasing <- read.table("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/associated_metabolites_decreasing_decreasing.txt", header = T, sep = "\t")
decreasing_decreasing <- decreasing_decreasing[,1]
data <- read.table("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/combined/2smr_mvmr_formatted_results.txt", header = T, sep = "\t", stringsAsFactors = T)
...
# MR ====
mr <- read.table("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/combined/2smr_mvmr_formatted_results.txt", header = T, sep = "\t", stringsAsFactors = T)
mr <- subset(mr, group == "Adiposity on cancer")

# negative control
negative_control <- read.table("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/combined/2smr_mvmr_formatted_results.txt", header = T, sep = "\t", stringsAsFactors = T)
...
pdf("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/figures/forestplot_positive_positive.pdf",
...
pdf("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/figures/forestplot_negative_negative.pdf",
    width = 16, height = 9, pointsize = 10)
...
pdf("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/figures/forestplot_new_style.pdf",
