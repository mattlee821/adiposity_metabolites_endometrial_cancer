...
# mvmr BMI ====
my_files <- list.files(path = "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/adiposity/bmi/", pattern = "*txt")
data <- list()
for (i in seq_along(my_files)) {
  data[[i]] <- read.table(paste0("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/adiposity/bmi/",file = my_files[i]), header = T, sep = "\t")
}
...
write.table(mvmr_result, "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/combined/bmi_mvmr_results_formatted.txt", 
...
write.table(mvmr_sensitivity, "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/combined/bmi_mvmr_sensitivity_formatted.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")


# mvmr WHR ====
my_files <- list.files(path = "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/adiposity/whr/", pattern = "*txt")
data <- list()
for (i in seq_along(my_files)) {
  data[[i]] <- read.table(paste0("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/adiposity/whr/",file = my_files[i]), header = T, sep = "\t")
}
my_files <- gsub("_int_imputed.txt", "", my_files)
my_files = gsub("_", "", my_files)
my_files = gsub("%", "pct", my_files)
...
mvmr_result <- bind_rows(mvmr_result, .id = "column_label")
mvmr_result <- subset(mvmr_result, select = -column_label)
write.table(mvmr_result, "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/combined/whr_mvmr_results_formatted.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
mvmr_sensitivity <- bind_rows(mvmr_sensitivity, .id = "column_label")
mvmr_sensitivity <- subset(mvmr_sensitivity, select = -column_label)
write.table(mvmr_sensitivity, "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/combined/whr_mvmr_sensitivity_formatted.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")


# mvmr WHRadjBMI ====
my_files <- list.files(path = "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/adiposity/whradjbmi/", pattern = "*txt")
data <- list()
for (i in seq_along(my_files)) {
  data[[i]] <- read.table(paste0("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/adiposity/whradjbmi/",file = my_files[i]), header = T, sep = "\t")
}
my_files <- gsub("_int_imputed.txt", "", my_files)
my_files = gsub("_", "", my_files)
my_files = gsub("%", "pct", my_files)
...
mvmr_result <- bind_rows(mvmr_result, .id = "column_label")
mvmr_result <- subset(mvmr_result, select = -column_label)
write.table(mvmr_result, "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/combined/whradjbmi_mvmr_results_formatted.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
mvmr_sensitivity <- bind_rows(mvmr_sensitivity, .id = "column_label")
mvmr_sensitivity <- subset(mvmr_sensitivity, select = -column_label)
write.table(mvmr_sensitivity, "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/combined/whradjbmi_mvmr_sensitivity_formatted.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
