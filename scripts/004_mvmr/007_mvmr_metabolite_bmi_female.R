...
my_files <- list.files(path = "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/metabolite_instruments/bmi/", pattern = "*txt")
metabolites <- list()
for (i in seq_along(my_files)) {
  metabolites[[i]] <- read.table(paste0("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/metabolite_instruments/bmi/",file = my_files[i]), header = T, sep = "\t")
}
...
my_files <- list.files(path = "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/adiposity_instruments/bmi/", pattern = "*txt")
adiposity <- list()
for (i in seq_along(my_files)) {
  adiposity[[i]] <- read.table(paste0("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/adiposity_instruments/bmi/",file = my_files[i]), header = T, sep = " ")
}
...
for (i in 1:length(adiposity))
  adiposity[[i]]$outcome <- "BMI"
for (i in 1:length(adiposity))
  adiposity[[i]]$id.outcome <- "BMI"
for (i in 1:length(adiposity))
...
for (i in 1:length(meta_table))
  write.table(meta_table[[i]], paste0("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/female/results/metabolites/bmi/",my_files[[i]]), 
