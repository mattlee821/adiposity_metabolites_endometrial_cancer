...
write.table(increasing_increasing, "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/associated_metabolites_increasing_increasing.txt", 
...
write.table(increasing_decreasing, "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/associated_metabolites_increasing_decreasing.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(decreasing_increasing, "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/associated_metabolites_decreasing_increasing.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
...
write.table(decreasing_decreasing, "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/associated_metabolites_decreasing_decreasing.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
