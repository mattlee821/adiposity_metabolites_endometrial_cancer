...
# negative control ====
data <- read.table("adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/results/negative_control.txt", header = T, sep = "\t")
...
write.table(mvmr_result, "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/results/combined/negative_control_mvmr_results_formatted.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")

## sensitivity ====
mvmr_sensitivity <- data[,c("exposure", "outcome", "group", "adjusted", "method", "fstat.exposure1", "fstat.exposure2", "Qstat", "Qpval")]
write.table(mvmr_sensitivity, "adiposity_metabolites_endometrial_cancer/analysis/004_mvmr/results/combined/negative_control_mvmr_sensitivity_formatted.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
