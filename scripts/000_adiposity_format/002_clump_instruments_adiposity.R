...
## WHR
data <- read_exposure_data("whr_snps.txt",
                                    clump = F,
                                    sep = "\t",
                                    snp_col = "rsID",
                                    beta_col = "BETA",
...
## WHRadjBMI
data <- read_exposure_data("whradjbmi_snps.txt",
                                    clump = F,
                                    sep = "\t",
                                    snp_col = "rsID",
                                    beta_col = "BETA",
