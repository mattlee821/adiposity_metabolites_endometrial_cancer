...
# female ====
data <- read.table("adiposity_metabolites_endometrial_cancer/analysis/002_adiposity_metabolite/female/combined/001_mr_results_bonferroni.txt", header = T, sep = "\t")
...
pdf("adiposity_metabolites_endometrial_cancer/analysis/002_adiposity_metabolite/female/combined/forestplot.pdf",
...
# combined ====
data <- read.table("adiposity_metabolites_endometrial_cancer/analysis/002_adiposity_metabolite/combined/combined/001_mr_results_bonferroni.txt", header = T, sep = "\t")
metabolites <- data$metabolite
...
pdf("adiposity_metabolites_endometrial_cancer/analysis/002_adiposity_metabolite/combined/combined/forestplot.pdf",
    width = 10, height = 45, pointsize = 10)
forestplot(df = plot_data,
           name = metabolite,
           estimate = b,
