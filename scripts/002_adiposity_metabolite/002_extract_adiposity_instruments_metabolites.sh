...
ls *.txt | while read f; do grep -w -F -f /newhome/ml16847/001_projects/adiposity_metabolites_endometrial_cancer/data/adiposity_GWAS/bf_snp_list.txt ${f} > /newhome/ml16847/001_projects/adiposity_metabolites_endometrial_cancer/data/adiposity_metabolites_outcomes/whradjbmi/${f}_adiposity_instruments.txt; done;
