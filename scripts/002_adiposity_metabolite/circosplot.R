...
# female ====
plot_data <- read.table("adiposity_metabolites_endometrial_cancer/analysis/002_adiposity_metabolite/female/combined/001_mr_results.txt", header = T, sep = "\t")
...
# circos plot ====
pdf("adiposity_metabolites_endometrial_cancer/analysis/002_adiposity_metabolite/female/combined/circosplot.pdf",
...
# combined ====
plot_data <- read.table("adiposity_metabolites_endometrial_cancer/analysis/002_adiposity_metabolite/combined/combined/001_mr_results.txt", header = T, sep = "\t")
plot_data$exposure <- factor(plot_data$exposure, levels = c("BMI", "WHR", "WHRadjBMI"))
plot_data <- droplevels(plot_data)
plot_data$UKB_subclass <- factor(plot_data$UKB_subclass, levels = c(
  "Amino acids", "Aromatic amino acids", "Branched-chain amino acids",
...
# circos plot ====
pdf("adiposity_metabolites_endometrial_cancer/analysis/002_adiposity_metabolite/combined/combined/circosplot.pdf",
    width = 45, height = 45, pointsize = 30)
circos_plot(track_number = 3,
            track1_data = plot_data1,
            track2_data = plot_data2,
