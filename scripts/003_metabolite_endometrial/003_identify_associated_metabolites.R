...
write.table(data, "adiposity_metabolites_endometrial_cancer/analysis/003_metabolite_endometrial/female/associated_metabolites.txt", 
...
data <- select(data, c("metabolite","outcome",
                       ...
                       "UKB_label","UKB_name","UKB_name2","UKB_unit","UKB_class","UKB_subclass","UKB_subclass_unit","UKB_derived"))
data <- subset(data, pval < 0.05)
write.table(data, "adiposity_metabolites_endometrial_cancer/analysis/003_metabolite_endometrial/combined/associated_metabolites.txt", 
            row.names = FALSE, col.names = TRUE, quote = FALSE, sep = "\t")
