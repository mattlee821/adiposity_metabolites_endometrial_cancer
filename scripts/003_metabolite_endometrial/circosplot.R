...
# data ====
plot_data <- read.table("adiposity_metabolites_endometrial_cancer/analysis/003_metabolite_endometrial/mr_results_formatted.txt", header = T, sep = "\t")
...
# circos plot ====
pdf("adiposity_metabolites_endometrial_cancer/analysis/003_metabolite_endometrial/figures/circosplot.pdf",
